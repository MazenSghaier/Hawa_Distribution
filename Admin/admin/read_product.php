...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="content"><?= $fetch_posts['resume']; ?></div>
      <div class="icons">
      ...
      <div class="flex-btn">
         <a href="edit_product.php?id=<?= $post_id; ?>" class="inline-option-btn">modifier</a>
         <button type="submit" name="delete" class="inline-delete-btn" onclick="return confirm('delete this post?');">supprimer</button>
         <a href="view_product.php" class="inline-option-btn">retourner</a>
      </div>
   </form>
   <?php
         }
