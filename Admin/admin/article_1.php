...
if(isset($_POST['publish'])){
   ...
   $select_image = $conn->prepare("SELECT * FROM `".TABLE_ARTICLE_ACCUEIL."` WHERE image = ? ");
   ...
   if($select_image->rowCount() > 0 AND $image != ''){
      ...
      $insert_post = $conn->prepare("INSERT INTO `".TABLE_ARTICLE_ACCUEIL."`( titre, contenu,  image) VALUES(?,?,?)");
      $insert_post->execute([ $titre,$image,$content]);
