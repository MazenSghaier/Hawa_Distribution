...
<section class="accounts">
   ...
   <div class="box" style="order: -2;">
      ...
      <a href="register_admin.php" class="option-btn" style="margin-bottom: .5rem;">S'inscrire</a>
   </div>
   ...
   <div class="box" style="order: <?php if($fetch_accounts['id'] == $admin_id){ echo '-1'; } ?>;">
      ...
      <div class="flex-btn">
         ...
         ?>
            <a href="update_profile.php" class="option-btn" style="margin-bottom: .5rem;">mettre à jour</a>
            <form action="" method="POST">
               <input type="hidden" name="post_id" value="<?= $fetch_accounts['id']; ?>" on>
               <button type="submit" name="delete"onclick="return confirm('delete the account?');" class="delete-btn" style="margin-bottom: .5rem;">supprimer</button>
            </form>
         <?php
            }
         ?>
