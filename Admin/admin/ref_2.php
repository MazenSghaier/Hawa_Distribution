...
if(isset($_POST['publish'])){
   ...
   $select_image = $conn->prepare("SELECT * FROM `ref_logo` WHERE image = ? ");
   ...
   if($select_image->rowCount() > 0 AND $image != ''){
      ...
      $insert_post = $conn->prepare("INSERT INTO `ref_logo`(position , image) VALUES(?,?)");
      $insert_post->execute([ $position, $image]);
