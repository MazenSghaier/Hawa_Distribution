...
if(isset($_POST['publish'])){
   ...
   $select_image = $conn->prepare("SELECT * FROM `".TABLE_ABOUT_IMAGES."` WHERE image = ? ");
   ...
   if($select_image->rowCount() > 0 AND $image != ''){
      ...
      $insert_post = $conn->prepare("INSERT INTO `".TABLE_ABOUT_IMAGES."`( titre, contenu, position, image) VALUES(?,?,?,?)");
