...
if(isset($_POST['publish'])){
   ...
   $select_image = $conn->prepare("SELECT * FROM `reference` WHERE image = ? ");
   ...
   if($select_image->rowCount() > 0 AND $image != ''){
      ...
      $insert_post = $conn->prepare("INSERT INTO `reference`( titre,position,image) VALUES(?,?,?)");
      $insert_post->execute([ $titre,$position, $image]);
